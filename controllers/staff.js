...
exports.getStaff = (req, res, next) => {
    res.render("viewStaff/staff-info", {
        ...
        path: "/staff",
        staff: req.staff,
        doB: `${req.staff.doB.getDate()}/${
      req.staff.doB.getMonth() + 1
    }/${req.staff.doB.getFullYear()}`,
        startDate: `${req.staff.startDate.getDate()}/${
      req.staff.startDate.getMonth() + 1
    ...
    Covid.find({ "staff.staffId": req.staff._id })
        .then((covidData) => {
            ...
            if (covid.dateInfection == undefined) {
                ...
                dateInfection = `${covid.dateInfection.getDate()}/${
          covid.dateInfection.getMonth() + 1
            ...
            return res.render("viewStaff/covid-info", {
                ...
                covid: covid,
                staffs: staffs,
                dateVaccine1: `${covid.dateVaccine1.getDate()}/${
          covid.dateVaccine1.getMonth() + 1
        }/${covid.dateVaccine1.getFullYear()}`,
                dateVaccine2: `${covid.dateVaccine2.getDate()}/${
          covid.dateVaccine2.getMonth() + 1
        }/${covid.dateVaccine2.getFullYear()}`,
                dateTemp: `${covid.dateTemp.getHours()}h${covid.dateTemp.getMinutes()} - ${covid.dateTemp.getDate()}/${
          covid.dateTemp.getMonth() + 1
        }/${covid.dateVaccine2.getFullYear()}`,
        ...
        .then((covid) => {
            ...
            pdfDoc
                ...
                .text(
                    `- Temperature: ${
            covid.temp
          }, time: ${covid.dateTemp.getHours()}h${covid.dateTemp.getMinutes()} - ${covid.dateTemp.getDate()}/${
            covid.dateTemp.getMonth() + 1
          }/${covid.dateVaccine2.getFullYear()}`
                );
            pdfDoc
                ...
                .fontSize(16)
                .text(
                    `- 1st day of injection: ${covid.dateVaccine1.getDate()}/${
            covid.dateVaccine1.getMonth() + 1
          }/${covid.dateVaccine1.getFullYear()}`
                );
            pdfDoc
            ...
            pdfDoc
                ...
                .fontSize(16)
                .text(
                    `- 2nd day of injection: ${covid.dateVaccine2.getDate()}/${
            covid.dateVaccine2.getMonth() + 1
          }/${covid.dateVaccine2.getFullYear()}`
                );
            pdfDoc
            ...
            if (!covid.dateInfection) {
                ...
                pdfDoc
                    ...
                    .fontSize(16)
                    .text(
                        `- Infected day: ${covid.dateInfection.getDate()}/${
              covid.dateInfection.getMonth() + 1
            }/${covid.dateInfection.getFullYear()}`
                    );
                pdfDoc
